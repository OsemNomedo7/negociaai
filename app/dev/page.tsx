          ...
          <div key={plan.id} style={{ background: "linear-gradient(145deg,#111827,#0f1420)", border: "1px solid rgba(255,255,255,.07)", borderRadius: 18, padding: "24px", position: "relative", overflow: "hidden" }}>
            ...
            {"id" in plan && (
              <div style={{ padding: "7px 10px", borderRadius: 7, background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", marginBottom: 14 }}>
                <div style={{ fontSize: 9, fontWeight: 700, color: "rgba(255,255,255,.25)", letterSpacing: ".1em", textTransform: "uppercase", marginBottom: 3 }}>URL do Webhook</div>
                <code style={{ fontSize: 10, color: "rgba(255,255,255,.5)", fontFamily: "monospace", wordBreak: "break-all" }}>/api/webhook/plan/{plan.id}</code>
              </div>
            )}
